# CKES-AWI-0002 — Applicability and Epistemic Modeling

[Home](../../../README.md) › [Architecture](../README.md) › [Watch Items](README.md) › CKES-AWI-0002

> **Status:** Active
> **Owner:** Architecture Team
> **Classification:** CKES hypothesis under CRA AWI-0002

## Question

How should context, applicability, and epistemic status affect canonicalization decisions?

## CKES Experimental Approach

- Semantic contexts in canonical schema
- CALS policy risk tiers (food safety vs stylistic knowledge)
- Contradiction preservation in policy engine
