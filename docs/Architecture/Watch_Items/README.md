...
Track open architectural questions CKES will investigate experimentally. These map to CRA watch items and CKES-0000 research questions.

## Active Watch Items

| ID | Title | CRA Reference | CKES Status |
|----|-------|---------------|-------------|
| [CKES-AWI-0001](CKES-AWI-0001-knowledge-evolution-and-canonicalization.md) | Knowledge Evolution and Canonicalization | [CRA AWI-0001](https://github.com/edbecnel/Canonical-Representation-Architecture/blob/main/docs/Architecture/Watch_Items/AWI-0001-knowledge-evolution-and-canonicalization.md) | Active — POC pipeline |
...
- [CKES-0000](../../../CKES-0000.md) §54
- [CRA Watch Items](https://github.com/edbecnel/Canonical-Representation-Architecture/tree/main/docs/Architecture/Watch_Items)
